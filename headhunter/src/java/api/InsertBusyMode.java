...
@WebServlet(name = "InsertBusyMode", urlPatterns = {"/InsertBusyMode"})

public class InsertBusyMode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
           ...
           int res=busymodeController.insertBusyMode(busymode);
           out.print(res);
        }
    }
